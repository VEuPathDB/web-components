...
interface HorizontalBarChartWithLinePlotDatum {
  barX: number[];
  barY: string[];
  lineX: number[];
  lineY: string[];
...
interface Props {
  data: HorizontalBarChartWithLinePlotDatum;
  plotTitle: string;
}

export default function HorizontalBarChartWithLinePlot(props: Props) {

...
import HorizontalBarCahrtWithLinePlot from './HorizontalBarChartWithLinePlot';


export default {
    title: 'HorizontalBarCahrtWithLinePlot',
    component: HorizontalBarCahrtWithLinePlot,
  };
...
export const BarChartWithLinePlot = () => <HorizontalBarCahrtWithLinePlot
